...
const SmallModal = ({ title, onClose }: DataProps) => {
      ...
      >
        ...
        <div className="p-6 flex-1 overflow-y-auto">
          <p className="text-gray-600 leading-relaxed">
            Ini adalah contoh modal ukuran <b>{title}</b>. Jika konten melebihi
            80% tinggi layar, maka hanya bagian ini yang akan scroll.
          </p>
        </div>
