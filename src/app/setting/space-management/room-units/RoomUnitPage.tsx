...
const columns: Column[] = [
  ...
  { title: "Floor", value: "floor", classname: "w-[12%]" },
  { title: "Type", value: "unit_type", classname: "w-[12%]" },
  { title: "Capacity", value: "capacity", classname: "w-[8%] text-center" },
...
const STATUS_FILTERS: { label: string; value: string }[] = [
  ...
  { label: ROOM_STATUS_LABEL[RoomStatus.OCCUPIED], value: RoomStatus.OCCUPIED },
  {
    ...
    value: RoomStatus.UNDER_MAINTENANCE,
  },
