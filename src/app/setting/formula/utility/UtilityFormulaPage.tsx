...
import { TableUtilityFormula } from "@/components/atoms/table/tableUtilityFormula";
import { UtilityFormulaApiDaum } from "@/types/utitlityFormula";
import CreateUtilityFormulaModal from "@/components/atoms/modals/create/CreateUtilityFormulaModal";
...
export const UtilityFormulaPage = ({ title, subtitle }: DataProps) => {
  ...
  /* ============================ DATA STATE ============================ */
  const [initiateData, setInitiateData] = useState<UtilityFormulaApiDaum[]>([]);
  const [, setIsLoading] = useState<boolean>(true);

  const fetchingData = useCallback(async () => {
    try {
      setIsLoading(true);
      const result = await apiGet<ListResponse<UtilityFormulaApiDaum>>(
        "/utility-formula",
        { page, limit, search },
        false,
      );
