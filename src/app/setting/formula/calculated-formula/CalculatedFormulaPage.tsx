...
export const CalculatedFormulaPage = ({ title, subtitle }: DataProps) => {
  ...
  const [initiateData, setInitiateData] = useState<CalculatedFormulaApiDaum[]>(
    [],
  );
