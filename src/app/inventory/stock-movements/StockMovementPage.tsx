...
import { StockMovementApiDaum } from "@/types/stockMovement";
import CreateStockMovementModal from "@/components/atoms/modals/create/CreateStockMovementModal";
import { TableStockMovement } from "@/components/atoms/table/tableStockMovement";
...
export const StockMovementPage = ({ title, subtitle }: DataProps) => {
  ...
  const [data, setData] = useState<StockMovementApiDaum[]>([]);
  ...
  const fetchingData = useCallback(async () => {
    try {
      const result = await apiGet<ListResponse<StockMovementApiDaum>>(
        "/stock-movement",
        { page, limit, search },
        false,
      );
