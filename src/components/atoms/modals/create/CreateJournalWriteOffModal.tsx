...
function SourceDocSelect({
  ...
  return (
    <Select
      instanceId="wo-source-doc-create"
      classNamePrefix="rs"
      isClearable
      options={options}
      value={selected}
...
export default function CreateJournalWriteOffModal({
  isOpen,
  onClose,
  onSuccess,
}: DataProps) {
    ...
    try {
      ...
      if (result.success) {
        await Swal.fire({
          ...
          text: result.message || "Your write off has been saved successfully.",
        ...
        <div className="max-w-full px-5 mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="group">
              ...
              <Select
                instanceId="wo-source-type-create"
                classNamePrefix="rs"
                    ...
                    return (
                      ...
                      >
                        <td className="py-2 px-3 align-top">
                          <Select
                            instanceId={`wo-line-account-${index}`}
                            classNamePrefix="rs"
