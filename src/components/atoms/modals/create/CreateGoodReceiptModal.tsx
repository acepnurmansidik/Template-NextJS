...
export default function CreateGoodReceiptModal({
  isOpen,
  onClose,
  onSuccess,
}: DataProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const result = await apiPost<SingleResponse<GoodReceiptApiDaum>>(
        "/good-receipt",
        payload,
        false,
        false,
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {!isMulti && (
              <div className="group">
                ...
                <Select
                  instanceId="gr-warehouse-create"
                  classNamePrefix="rs"
                      ...
                      return (
                        ...
                        >
                          ...
                          {isMulti && (
                            <td className="py-2 px-3 align-top">
                              <Select
                                instanceId={`gr-item-wh-create-${index}`}
                                classNamePrefix="rs"
                                placeholder="Gudang…"
                                options={warehouseOptions}
