...
const defaultValue: ComponentFormulaForm = {
  name: "",
...
export default function CreateComponentFormulaModal({
  isOpen,
  onClose,
  onSuccess,
}: DataProps) {
  const [formData, setFormData] = useState<ComponentFormulaForm>(defaultValue);
  ...
  // Field rate aktif tergantung tipe (backend memilih salah satu).
        ...
        <div className="max-w-full px-5 mx-auto space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="group">
              ...
              <Select
                instanceId="component-rate-type-create"
                classNamePrefix="rs"
