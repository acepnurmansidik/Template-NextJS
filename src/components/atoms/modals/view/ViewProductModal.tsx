...
import { ProductApiDaum, refLabel, imageRefPath } from "@/types/product";
            ...
            <span
              className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold border ${
                isActive
                  ...
                  : "border-zinc-300 bg-zinc-50 text-zinc-600 dark:bg-zinc-800 dark:text-zinc-400 dark:border-zinc-700"
              }`}
            >
          ...
          {imgPath && (
            <div>
              ...
              <img
                ...
                className="w-full max-w-xs h-48 object-cover rounded-lg border border-zinc-200 dark:border-zinc-700"
              />
            </div>
          )}

          <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
            <Field label="Code / SKU" value={initialData.code} />
            ...
            <Field
              ...
              value={
                <span className="font-mono">
                  {formatCurrencyPure(initialData.purchase_price ?? 0)}
                </span>
              }
            />
            <Field
              ...
              value={
                <span className="font-mono">
                  {formatCurrencyPure(initialData.selling_price ?? 0)}
                </span>
              }
            />
