...
// Product membawa uom_id (populate) supaya UOM diturunkan otomatis.
...
export default function UpdateStockPositionModal({
  isOpen,
  initialData,
  onClose,
  onSuccess,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const result = await apiPut<SingleResponse<StockPositionApiDaum>>(
        `/stock-position/${initialData._id}`,
        payload,
        false,
        false,
      );
        ...
        <div className="max-w-full px-5 mx-auto space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="group">
              ...
              <Select
                instanceId="stock-product-update"
                classNamePrefix="rs"
            ...
            <div className="group">
              ...
              <Select
                instanceId="stock-warehouse-update"
                classNamePrefix="rs"
