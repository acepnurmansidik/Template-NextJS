...
export default function UpdateUtilityFormulaModal({
  isOpen,
  onClose,
  onSuccess,
  initialData,
}: DataProps) {
  const [formData, setFormData] = useState<UtilityFormulaForm>({
    name: "",
    code: "",
  });
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const result = await apiPut<SingleResponse<UtilityFormulaApiDaum>>(
        `/utility-formula/${initialData._id}`,
        payload,
        false,
        false,
      );
