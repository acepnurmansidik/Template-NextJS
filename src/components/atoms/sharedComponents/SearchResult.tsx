...
export default function SearchPanel({
  ...
  return (
    ...
    >
      ...
      <div className="col-span-2">
        <div className="relative mt-1 shadow-md">
          ...
          <input
            ...
            type="text"
            value={searchQuery}
            className="w-full bg-white pl-10 pr-24 py-3 border border-slate-300 outline-none rounded-xl text-sm placeholder:italic"
      ...
      {/* SEARCH RESULT */}
      <div className="col-span-2 rounded-xl border border-gray-200 bg-white p-4 shadow-md max-h-96 overflow-y-auto">
        {/* HISTORY SECTION */}
        {history.length > 0 && (
          <div className="mb-4">
