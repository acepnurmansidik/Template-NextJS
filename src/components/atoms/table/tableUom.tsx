...
export const TableUom = ({
  ...
  const handleDelete = async (row: UomApiDaum) => {
    try {
      ...
      const result = await apiDelete<SingleResponse<UomApiDaum>>(
        `/uom/${row._id}`,
        {},
        false,
      );
  ...
  const renderCell = (row: UomApiDaum, value: string) => {
    switch (value) {
      case "code":
        return (
                    ...
                    <div className="flex flex-col items-center justify-center gap-3">
                      ...
                      <div className="space-y-0.5">
                        ...
                        <p className="text-xs text-gray-400 dark:text-zinc-500 max-w-xs mx-auto">
                          There are no units of measure found. Try creating a new
