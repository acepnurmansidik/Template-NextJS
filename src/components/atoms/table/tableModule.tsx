      ...
      <div className="overflow-hidden">
        <div className="overflow-y-auto max-h-100 custom-scrollbar">
          <table className="w-full text-left">
            {/* Thead: Ditambahkan bg dark-mode dinamis agar saat di-scroll text header tidak tabrakan */}
            ...
            <tbody>
              {data.length === 0 ? (
                ...
                <tr>
                  ...
                  >
                    <div className="flex flex-col items-center justify-center gap-3 transition-colors duration-300">
                      {/* Ikon Box Terbuka yang Dinamis Mengikuti Tema */}
                ...
                /* TAMPILAN JIKA DATA ADA (LOGIKA LAMA KAMU) */
                            ...
                            <div className="flex items-center text-gray-500 dark:text-zinc-400">
                              {hasAccess.whatsapp && (
                                <button
                                  ...
                                  className="h-7 w-7 flex items-center justify-center rounded-md hover:text-[#20bd5a] hover:bg-green-50 dark:hover:bg-blue-900/30 cursor-pointer"
                                >
                              ...
                              {hasAccess.pdf && (
                                <button
                                  ...
                                  className="h-7 w-7 flex items-center justify-center rounded-md hover:text-red-500 hover:bg-red-50 dark:hover:bg-blue-900/30 cursor-pointer"
                                >
                                  <FaFilePdf size={18} />
                                </button>
                              )}
